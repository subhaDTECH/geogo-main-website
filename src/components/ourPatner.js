        ...
        <div className="container h-full mx-auto w-[95%] p-5 m-3 my-10 p-10">
              ...
              <div className="row grid grid-cols-2 md:grid-cols-4 gap-2">
                   ...
                   <div className="Img-box  p-4 md:m-3">
                       <a className="no-underline" target="_blank"  href="https://www.digitalocean.com/">
                          <img alt="Img" src="https://www.geogo.in/static/44af6a9a3484ab9a5b2d3c4463f8cdee/49aa0a09-06d2-4bba-ad20-4bcbe56ac507_logo.png" />
                       </a>
                   </div>
                   <div className="Img-box  p-4 md:m-3">
                       <a className="no-underline" target="_blank" href="http://www.indishtech.com/">
                        <img alt="Img" src="https://www.geogo.in/static/a856af8653ac18314e7e2417f08a0738/indish-technology-logo.png" />
                       </a>
                   </div>
                   <div className="Img-box  p-4 md:m-3">
