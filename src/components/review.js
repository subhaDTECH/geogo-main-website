                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-lg overflow-hidden shadow-lg transition-transform transform ease-in-out hover:shadow-xl ease-in-out">
                        ...
                        <div class="p-8">
                            ...
                            <p class="text-sm  text-gray-800 my-2">Solutions Architect, Fortune 500 Manufacturing Company</p>

                        </div>
                        <div class="p-4">
                            <button
                                class="bg-[#32373c] w-[160px] mx-auto  text-white rounded-sm px-4 py-2  focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
                                View Full Review
                            </button>
                        </div>
                    </div>
