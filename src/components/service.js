                  ...
                  <div className="container h-full mx-auto w-[95%] p-5 m-3 my-10 p-10">
                        ...
                        <div className="h-full w-full flex flex-row justify-center flex items-center border border-gray-200 hover:bg-white  rounded-sm transition transform ease-in-out duration-300 hover:shadow-xl ease-in-out">
                                    <div className="Img-container  md:flex items-center justify-center">
                                          <img className="team-Img items-center mx-auto " src="https://www.geogo.in/static/9afe3591474a8d95a4555b174dcbb739/Screenshot-2021-04-13-at-3.46.22-PM.jpg" />
                                    </div>
                              ...
                              <div className="h-full w-full flex flex-row justify-center flex items-center border border-gray-200 hover:bg-white  rounded-sm transition transform ease-in-out duration-300 hover:shadow-xl ease-in-out">
                                    <div className="Img-container  md:flex items-center justify-center">
                                          <img className="team-Img items-center mx-auto " src="https://www.geogo.in/static/942c1612824f412bed0d239bb65f30e4/Screenshot-2021-04-13-at-3.48.12-PM.jpg" />
                                    </div>
                                    <div className="flex flex-col w-full md:w-[60%]   p-3 m-3">
                                          <p>We practice</p>
                                          <h2 className="text-2xl md:text-4xl">Creativity at Core</h2>
                                          <span className="py-3 my-5 "><a href="#" className="no-underline">Explore our services</a></span>
                                    </div>
                              </div>
                              <div className="h-full w-full flex flex-row justify-center flex items-center border border-gray-200 hover:bg-white  rounded-sm transition transform ease-in-out duration-300 hover:shadow-xl ease-in-out">
                                    <div className="Img-container  md:flex items-center justify-center">
                                          <img className="team-Img items-center mx-auto " src="https://www.geogo.in/static/4558d3961acb15314bd59d7ad9d636ce/Agile-e1618309457190-min.png" />
                                    </div>
                                    <div className="flex flex-col w-full md:w-[60%]   p-3 m-3">
                                          <p>Our process is</p>
                              ...
                              <div className="h-full w-full flex flex-row justify-center flex items-center border border-gray-200 hover:bg-white  rounded-sm transition transform ease-in-out duration-300 hover:shadow-xl ease-in-out">
                                    <div className="Img-container  md:flex items-center justify-center">
                                          <img className="team-Img items-center mx-auto " src="https://www.geogo.in/static/5dfa26afaec2863684b67d33a36f2236/Screenshot-2021-04-13-at-3.58.29-PM.jpg" />
                                    </div>
                                    <div className="flex flex-col w-full md:w-[60%]   p-3 m-3">
                                          <p>Powered by</p>
