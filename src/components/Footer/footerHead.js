...
const FooterHead = () => (
  <div className=" h-[100%]   w-full flex flex-col lg:flex-row z-20">
    ...
    >
      <p className="text-lg  sm:mx-5 lg:mx-10 px-3 font-normal">Solutions</p>
      ...
      <div className="right-box-context   lg:mt-[-60px] flex flex-col lg:flex-row  lg:mx-10 gap-2  items-center justify-center">
        <div className="btn-box-container sm:my-5 sm:px-5 lg:px-0 lg:my-0   lg:mt-[-55px] w-[100%] lg:w-[50%] flex flex-col items-center justify-center ">
          <div className="w-full  mt-4 lg:mt-0">
            ...
            <button className="text-start  text-[#464646] w-full mt-2  hover:bg-gray-100  hover:border-green-500  font-semibold py-2 px-4 border border-gray-400 rounded shadow">
              <Link to="/contact" className="no-underline  text-[#464646]">
                Get our Service
              </Link>
            </button>
          </div>
          <button className=" text-start  text-[#464646] w-full  m-2  hover:bg-gray-100  hover:border-green-500  font-semibold py-2 px-4 border border-gray-400 rounded shadow">
            <Link to="/contact" className="no-underline  text-[#464646]">
              Become Our Patner
            </Link>
          </button>
          <button className="text-start w-full   text-[#464646] m-2  hover:bg-gray-100  hover:border-green-500  font-semibold py-2 px-4 border border-gray-400 rounded shadow">
            <Link to="/contact" className="no-underline  text-[#464646]">
              Join Our Team
            </Link>
          </button>
        ...
        <div className="content-box    py-4  p-5  my-5 mx-3 w-[100%] lg:w-[60%]  flex  flex-col  justify-center">
          ...
          <div className="flex flex-row justify-center">
            ...
            <div className="p-2 m-2">
              <h3 className="text-[16px]">Same Day Response is Guaranteed!</h3>
              <p className="text-sm text-[#464646]">
