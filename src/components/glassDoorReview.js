    ...
    <div className="Career-Section my-10 py-5">
     ...
     {/* first row start  */}
           <div className="row container flex grid grid-cols-1 md:grid-cols-3">
              ...
              <div class="border  w-[14px] bg-green-500 h-[70%]"></div>
                   <p className="text-lg px-4">The founding members are extremely employee-friendly.
                    They provide ample opportunities to learn and grow. As a fresher one will be allowed to experience working in different areas to find what best suits them.</p>
            </div>
     ...
     {/* second review box start  */}
      ...
      <div className="row container  flex grid grid-cols-1 md:grid-cols-3">
              <div className="box h-[360px] w-full flex flex-row  justify-center md:order-none">
              <div class="border  w-[14px] bg-green-500 h-[70%]"></div>
                   <p className="text-lg px-4 ">Seniors are just amazing mentors and very supportive. Work-life balance is nice (rare at startups). 
                   CEO interacts with employees as a friend rather than a boss..</p>
            </div>
     ...
     {/* second review box start  */}
              ...
              <div className="box h-[360px] w-full flex flex-row  justify-center md:order-none">
              <div class="border  w-[14px] bg-green-500 h-[70%]"></div>
                   <p className="text-lg px-4 ">The best place to cultivate your skills to the right direction. 
                   Company with great core values and cultures and productive ideas. Great mentors and Teammates.</p>
              </div>
      ...
      {/* 3rd review start  */}
              ...
              <div className="box h-[360px] w-full flex flex-row  justify-center md:order-none">
              <div class="border  w-[14px] bg-green-500 h-[70%]"></div>
                   <p className="text-lg px-4">A healthy environment to work , People around me are generally helpful and collaborative , 
                   Every thing is quite organised here. One can loearn a lot of things while working here.</p>
              </div>
