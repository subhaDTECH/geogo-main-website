...
const InternCard = ({ programs }) => {
  return (
    <div className="Job-Section my-6 py-5 p-5">
      <div className="container h-full mx-auto w-[95%] p-5 m-3 my-5">
        <h1 className="  text-2xl md:text-4xl font-bold  p-2 m-2">
          Intern with us
        </h1>
            ...
            return (
              ...
              >
                ...
                <div className="job-content p-4 m-2">
                  ...
                  >
                    <a className="no-underline text-white" href={program?.link}>
                      Apply Now
                    </a>
                  </button>
                </div>
