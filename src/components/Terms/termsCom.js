        ...
        <div className="container h-full mx-auto w-[95%] p-5 m-3 my-10 p-10 bg-white">
          ...
          <div className="flex  flex-col md:flex-col justify-center py-10">
            <div className="content-box w-full md:w-1/2  mx-auto p-5">
              <p className="text-[26px]">Welcome to Geogo!</p>
              <p className="text-[18px] py-2">
                These terms and conditions outline the rules and regulations for
                the use of Geogo Techsolutions Pvt Ltd's Website, located at
               <strong> https://www.geogo.in.</strong>
              </p>
              <p className="text-[18px] py-2">
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use geogo.in if you do not agree
          ...
          <div className="flex  flex-col md:flex-col justify-center py-10">
            ...
            <div className="content-box w-full md:w-1/2  mx-auto p-5">
              <p className="text-[18px]">
                We employ the use of cookies. By accessing geogo.in, you agreed
                to use cookies in agreement with the Geogo Techsolutions Pvt
          ...
          <div className="flex  flex-col md:flex-col justify-center py-10">
            ...
            <div className="content-box w-full md:w-1/2  mx-auto p-5">
              <p className="text-[18px]">
                Unless otherwise stated, Geogo Techsolutions Pvt Ltd and/or its
                licensors own the intellectual property rights for all material
                on geogo.in. All intellectual property rights are reserved. You
                may access this from geogo.in for your own personal use
                subjected to restrictions set in these terms and conditions.
              </p>
              <p className="text-[18px]">You must not: </p>
              ...
              <p className="text-[18px]">
                ...
                website. Geogo Techsolutions Pvt Ltd does not filter, edit,
                publish or review Comments prior to their presence on the
                website. Comments do not reflect the views and opinions of Geogo
                Techsolutions Pvt Ltd,its agents and/or affiliates. Comments
                reflect the views and opinions of the person who post their
                views and opinions. To the extent permitted by applicable laws,
                Geogo Techsolutions Pvt Ltd shall not be liable for the Comments
              ...
              <p className="text-[18px]">
                Geogo Techsolutions Pvt Ltd reserves the right to monitor all
              ...
              <p className="text-[18px]">
                You hereby grant Geogo Techsolutions Pvt Ltd a non-exclusive
          ...
          <div className="flex  flex-col md:flex-col justify-center py-10">
            ...
            <div className="content-box w-full md:w-1/2  mx-auto p-5">
              ...
              <p className="text-[18px]">
                ...
                of Geogo Techsolutions Pvt Ltd; and (d) the link is in the
                ...
                and (c) fits within the context of the linking party’s site. If
                you are one of the organizations listed in paragraph 2 above and
                are interested in linking to our website, you must inform us by
                sending an e-mail to Geogo Techsolutions Pvt Ltd. Please include
              ...
              <p>
                No use of Geogo Techsolutions Pvt Ltd's logo or other artwork
