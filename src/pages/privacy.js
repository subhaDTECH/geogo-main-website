        ...
        <div className="container h-full mx-auto w-[95%] p-5 m-3 my-10 p-10 bg-white">
            ...
            <div className="content-box w-full md:w-1/2  mx-auto p-5">
              ...
              <ul>
                ...
                <li>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to GEOGO
                  Techsolutions Pvt Ltd, Bengaluru, India.
                </li>
                ...
                <li>
                  {" "}
                  <strong>Cookies</strong> Country refers to: Karnataka, India
                </li>

                <li>
                  <strong> Cookies</strong> Device means any device that can
          ...
          <div className="flex  flex-col md:flex-col justify-center py-10">
            ...
            <div className="content-box w-full md:w-1/2  mx-auto p-5">
              ...
              <ul>
                <li>
                  <strong>Necessary / Essential CookiesType</strong>: Session
                  CookiesAdministered by: UsPurpose: These Cookies are essential
                ...
                <li>
                  <strong>Cookies Policy / Notice</strong> Acceptance
                  CookiesType: Persistent CookiesAdministered by: UsPurpose:
                  These Cookies identify if users have accepted the use of
                  cookies on the Website.
                </li>
                <li>
                  <strong>Functionality CookiesType:</strong> Persistent
                  CookiesAdministered by: UsPurpose: These Cookies allow us to
