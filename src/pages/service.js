          ...
          <div className="right-box p-5 mx-5 w-full">
            ...
            <div className="digital-product-box my-8 p-5 shadow-lg">
              <h2 className="text-2xl font-semibold">
                Enterprise-grade digital product, for your unique business needs
              </h2>
              <p className="text-[16px] opacity-0.8">
                ...
                technologies. We are the catalyst for the change that you want
            ...
            <div className="agile-service-box my-8 p-5 shadow-lg">
              <h2 className="text-2xl font-semibold">
                Agile services, built to maximize the speed of doing business.
              </h2>
              <p className="text-[16px] opacity-0.8">
                With our DevOps as a service offering, we ensure rapid
                on-boarding of applications by automating end-to-end delivery
                pipeline and facilitate continuous integration and development
                across leading cloud platforms. We will help you leverage
                collaboration, tool-chain pipelines, monitoring, automation and
                Cloud adoption..
              </p>
              <p className="text-[18px]">Microservices</p>
              <p className="text-[18px]">Mobile App Development</p>
            ...
            <div className="agile-service-box my-8 p-5 shadow-lg">
              ...
              <p className="text-[16px] opacity-0.8">
                ...
                enable you to automate your business processes to make it fast
                and effective. We work together to connect your various
                disparate systems to deliver business information at right place
                at right time through right medium.
              </p>
              <p className="text-[18px]">Microservices</p>
              <p className="text-[18px]">Mobile App Development</p>
              <p className="text-[18px]">UI & UX</p>
            ...
            <div className="agile-service-box my-8 p-5 shadow-lg">
              <h2 className="text-2xl font-semibold">
                We help organisations with Remote Hiring – Assessment –
                Outsourcing – Trainings.
              </h2>
              <p className="text-[16px] opacity-0.8">
                People resource are key to your business success. We go beyond
                technology and provide solutions by helping you to hire right
                talent. You can leverage our remote hiring tools and processes
                to make the hiring process faster. We get things done by setting
                up your Offshore work centres if needed..
              </p>
