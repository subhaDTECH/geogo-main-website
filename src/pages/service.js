          ...
          <div className="row my-8 p-5 flex flex-col lg:flex-row">
            <div className="left-box w-full lg:w-1/2  sticky">
              <ul>
                <li className="m-2 p-2 cursor-pointer">
                  <a href="#service1" className="no-underline text-black">
                    Digital Products Engineering
                  </a>
                </li>
                <li className="m-2 p-2 cursor-pointer">
                  <a href="#service2" className="no-underline text-black">
                    Agile Service Management
                  </a>
                </li>
                <li className="m-2 p-2 cursor-pointer">
                  <a href="#service3" className="no-underline text-black">
                    Business Process Automation
                  </a>
                </li>
                <li className="m-2 p-2 cursor-pointer">
                  <a href="#service4" className="no-underline text-black">
            ...
            <div className="right-box p-5 mx-5 w-full">
              ...
              {services &&
                services
                  .filter(
                    service => service.title === "Digital Products Engineering"
                  )
                  .map((service, index) => (
                    <div
                      key={index}
              ...
              {services &&
                services
                  .filter(
                    service => service.title === "Agile Service Management"
                  )
                  .map((service, index) => (
                    <div
                      key={index}
              ...
              {services &&
                services
                  .filter(
                    service => service.title === "Business Process Automation"
                  )
                  .map((service, index) => (
                    <div
                      key={index}
              ...
              <h1 id="service4" className="text-4xl font-semibold">
                Recruitment & Training
              </h1>
